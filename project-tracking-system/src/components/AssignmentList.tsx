  ...
  const fetchAssignments = async () => {
    ...
    return (
      <div>
        ...
        <button type="button" className="btn btn-primary rounded-pill shadow my-3 ml-auto"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-plus-square-fill mr-2" viewBox="0 0 16 16">
